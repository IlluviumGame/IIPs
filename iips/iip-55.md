...
![image](../assets/iip-55/land-tier-bonus.png)

**Training Costs**

Here’s an example of the Training Grounds costs, X represents the fuel cost:

![image](../assets/iip-55/training-costs.png)
...
![image](../assets/iip-55/illuvial-staking-bonus.png)
